...
int
Service_Id_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
Service_Id_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
Service_Id_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	Service_Id_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
Service_Id_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
Service_Id_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Service_Id_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
Service_Id_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Service_Id_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_Service_Id_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (28 << 2))
};
asn_TYPE_descriptor_t asn_DEF_Service_Id = {
	"Service-Id",
	"Service-Id",
	Service_Id_free,
	Service_Id_print,
	Service_Id_constraint,
	Service_Id_decode_ber,
	Service_Id_encode_der,
	Service_Id_decode_xer,
	Service_Id_encode_xer,
	0, 0,	/* No PER support, use "-gen-PER" to enable */
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_Service_Id_tags_1,
	sizeof(asn_DEF_Service_Id_tags_1)
		/sizeof(asn_DEF_Service_Id_tags_1[0]), /* 1 */
	asn_DEF_Service_Id_tags_1,	/* Same as above */
	sizeof(asn_DEF_Service_Id_tags_1)
		/sizeof(asn_DEF_Service_Id_tags_1[0]), /* 1 */
