...
int
SIP_Method_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
SIP_Method_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
SIP_Method_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	SIP_Method_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
SIP_Method_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
SIP_Method_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SIP_Method_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
SIP_Method_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SIP_Method_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_SIP_Method_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (28 << 2))
};
asn_TYPE_descriptor_t asn_DEF_SIP_Method = {
	"SIP-Method",
	"SIP-Method",
	SIP_Method_free,
	SIP_Method_print,
	SIP_Method_constraint,
	SIP_Method_decode_ber,
	SIP_Method_encode_der,
	SIP_Method_decode_xer,
	SIP_Method_encode_xer,
	0, 0,	/* No PER support, use "-gen-PER" to enable */
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_SIP_Method_tags_1,
	sizeof(asn_DEF_SIP_Method_tags_1)
		/sizeof(asn_DEF_SIP_Method_tags_1[0]), /* 1 */
	asn_DEF_SIP_Method_tags_1,	/* Same as above */
	sizeof(asn_DEF_SIP_Method_tags_1)
		/sizeof(asn_DEF_SIP_Method_tags_1[0]), /* 1 */
